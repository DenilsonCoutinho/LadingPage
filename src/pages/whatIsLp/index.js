...
import img1 from '../../assets/whatIsLp/Screenshot_1.png'
import img2 from '../../assets/whatIsLp/Screenshot_2.png'
import img4 from '../../assets/whatIsLp/Screenshot_4.png'
import img3 from '../../assets/whatIsLp/Screenshot_3.png'
//style
        ...
        <div className={`${style.slide} `}>
          <div className={`${style.slider}`}>
            <div className={`${style.slideTrack} `}>
              ...
              <Image src={img2} width={500} />
              <Image src={img3} width={500} />
              <Image src={img4} width={500} />
              <Image src={img1} width={500} />
              <Image src={img2} width={500} />
              <Image src={img3} width={500} />
              <Image src={img4} width={500} />
