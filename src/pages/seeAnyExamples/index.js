...
export default function SeeAnyExamples() {
  return (
    <>
      <div className="flex flex-col justify-center items-center max-w-[1000px] m-auto my-44">
        <h1 className="linearText text-center text-4xl font-semibold ">Veja alguns exemplos</h1>
